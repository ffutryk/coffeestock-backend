...
export default function Layout({ usuario, onLogout }) {
  ...
  const filteredNavItems = navItems.filter(
    (item) => !item.allowedRoles || item.allowedRoles.includes(usuario?.role),
  );
        ...
        <div className="header-right">
          ...
          >
            ...
            >
              ...
              <path
                d="M16 32H10.6667C9.95942 32 9.28115 31.719 8.78105 31.219C8.28095 30.7189 8 30.0406 8 29.3333V10.6667C8 9.95942 8.28095 9.28115 8.78105 8.78105C9.28115 8.28095 9.95942 8 10.6667 8H16M25.3333 13.3333L32 20L25.3333 26.6667M32 20H16"
                stroke="white"
                stroke-width="4"
                stroke-linecap="round"
                stroke-linejoin="round"
